...
3. Later go to JAVA_SDK constants.java and enter all the credentials of database and Meet Hour credentials as well.
...
GitHub Actions
Tests are run whenever there is a commit, see .github/workflows/Test.java for details.
